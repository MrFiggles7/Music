$(document).ready(function () {
    ...
    var thingOne = ["E", "D", "C", "D", "E", "E", "E"];
    var thingOneOctave = [3,3,3,3,3,3,3];

    var songOne = ["A", "G", "F", "G", "A", "A", "A"];
    var songOneHarmony = [3,3,3,3,3,3,3];

    var songTwo = ["D", "E", "F", "G", "E", "C", "D"];
    var songTwoOctave = [4,4,4,4,4,4,4];
    ...
    function playSongOne(){
        ...
        thingOne.forEach(function (entry, index) {
            setTimeout(function () {
                playNote(thingOne[index], thingOneOctave[index]);
                playNote(songOne[index], songOneHarmony[index]);
            }, index * 500);
        })
    ...
    function playSongTwo(){
        songTwo.forEach(function (entry, index) {
            setTimeout(function () {
                playNote(songTwo[index], songTwoOctave[index]);
            }, index * 300);
        })
    }
